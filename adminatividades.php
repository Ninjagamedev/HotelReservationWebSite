...
<body>
    ...
    <h3 class="panel-title">Atividades</h3>
                            <div class="pull-right">
                              <button class="btn btn-default btn-xs" data-toggle="modal" data-target=".animate" data-ui-class="a-lightSpeed"  style="background: #d2d9d4;"><span class="glyphicon glyphicon-filter"></span>Inserir Atividade</button>
                        ...
                        <table class="table">
                            <thead>
                                ...
                                <tr class="filters" style="text-align:center">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Preco" disabled></th>
                            ...
                            <tbody>
                              ...
                              include("Conexao.php");
                                ...
                                if (isset($_GET['pageno'])) {
                                 ...
                                 $total_pages_sql = "SELECT COUNT(*) FROM atividade";
                                 $result = mysqli_query($conn,$total_pages_sql);
                                 $total_rows = mysqli_fetch_array($result)[0];
                                 $total_pages = ceil($total_rows / $no_of_records_per_page);

                                 $sql = "SELECT ID,Nome,Categoria,Cidade,left(Descricao, 30) as Descricao,Morada,Preco,Horario FROM atividade LIMIT $offset, $no_of_records_per_page";
                                 ...
                                 while($row = mysqli_fetch_array($res_data)){
                                     ...
                                     echo '  <td>
                                                              <a class="edit" title="Edit" data-toggle="tooltip" href="editaratividade.php?Id='.$row["ID"].'"><i class="material-icons">&#xE254;</i></a>
                                                             <a class="delete" title="Delete" data-toggle="tooltip" href="deleteutilizador.php?Id='.$row["ID"].'"><i class="material-icons">&#xE872;</i></a></td>
                                                           </td>';
                                     echo "</tr>";
                                 }
            ...
            <div class="modal animate col-md-12 col-lg-12" tabindex="-1" role="dialog" id="modalad" aria-hidden="true" data-backdrop="true" style="max-height:120vh;">
                        ...
                        <form class="" action="insertatividade.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-sm-4">
      ...
      <div class="tab-content">
        ...
        <br>
                    ...
                    <div class="col-sm-6">
<h5>Nome</h5>
                    <input type="text" name="NomeAlojamento" onkeyup="success()" id="NomeAlojamento" value="" placeholder="Nome da Atividade">
                  </div>
...
<h5>Ponto de Encontro</h5>
                        <input type="text" name="Morada" onkeyup="success()" id="Morada" value="" placeholder="Ponto de Encontro">
                      </div>
  </div>
  <div class="row">
                      <div class="col-sm-6">
<h5>Horário</h5>
                        <input type="Number" name="HoraInicio" onkeyup="success()" id="Quarto" min="1" max="24" value="" placeholder="Hora de Inicio" style="width:65%">
                        <input type="Number" name="HoraFim" onkeyup="success()" id="Quarto" min="1" max="24" value="" placeholder="Hora De Encerramento" style="width:65%">
                      </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="col-sm-3 text-right" style="width:70px !important">
                            <label for="Precos">Preço da Atividade</label>
                        </td>
                        <td class="col-sm-3">

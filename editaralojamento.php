...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    if(isset($_GET['Id'])) {
      ...
      $ID = $_GET['Id'];
      $sql = "SELECT * FROM alojamento Where ID='". $ID ."' ";
...
<br>
				...
				<form class="" action="editaralojamentoback.php" method="post" enctype="multipart/form-data">
...
<div class="row" style="width:100%;margin-top:25px;">
  <div class="col-sm-8" style="">
    <h5>Classificação</h5>
                            <div class="rate" style="margin-left:auto;">

...
session_start();
  include "navbar.php"; ?>
    ...
    <h3 class="panel-title">Reservas Efectuadas</h3>
                        ...
                        <table class="table" id="tabelapaginator">
                            ...
                            <tbody>
                              ...
                              if (isset($_GET['pageno'])) {
                               ...
                               $sql4 = "SELECT ID,Username FROM utilizador where Username = '".$_SESSION['username']."' LIMIT 1";
...
$ID = $row4['ID'];
                               ...
                               $sql = "SELECT *  FROM reserva where IDUtilizador = '".$ID."' LIMIT $offset, $no_of_records_per_page";

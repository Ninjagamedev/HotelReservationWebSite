...
<body>
    ...
    <h3 class="panel-title">Quartos</h3>
                          ...
                          <form action="editarquarto.php" method="POST">
                        <table class="table">
                            <thead>
                                ...
                                <tr class="filters" style="text-align:center">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Quarto" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Alojamento" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Disponivel" disabled></th>
                            ...
                            <tbody>
                              ...
                              include("Conexao.php");
                                ...
                                if (isset($_GET['pageno'])) {
                                 ...
                                 $total_pages_sql = "SELECT COUNT(*) FROM quarto";
                                 $result = mysqli_query($conn,$total_pages_sql);
                                 $total_rows = mysqli_fetch_array($result)[0];
                                 $total_pages = ceil($total_rows / $no_of_records_per_page);

                                 $sql = "SELECT *  FROM quarto LIMIT $offset, $no_of_records_per_page";
                                 ...
                                 while($row = mysqli_fetch_array($res_data)){
                                     ...
                                     echo '  <td>
                                     <button type="submit" class="add" title="Add" style="display:none"><i class="material-icons">&#xE03B;</i></button>
                                                           <a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                                             <a class="delete" title="Delete" data-toggle="tooltip" href="deletequarto.php?Id='.$row["ID"].'"><i class="material-icons">&#xE872;</i></a></td>
                                                           </td>';
                                     echo "</tr>";
                                 }
...
<script src="Editar/EditarQuarto.js"></script>
